...
#' @return MP object
#' @export
MP <- function(group, t, att, V_analytical, se, c, inffunc, n=NULL, W=NULL, Wpval=NULL, aggte=NULL, alp = 0.05, DIDparams=NULL, setup_n) {
  ...
  DIDparams=DIDparams, call=DIDparams$call, setup_n=setup_n)
  class(out) <- "MP"
  out
}
